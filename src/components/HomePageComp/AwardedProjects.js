...
// 
import MapareaSocietățiiCivileLugoj from "../ProjectPages/MapareaSocietățiiCivileLugoj"
// 
function HeroAwardedProjects() {

 const projects = [
    {id:1, title: "Maparea Societății Civile Lugoj" , button :"See Project" ,pic : Proj1, link : "/MapareaSocietățiiCivileLugoj"},
    {id:2, title: "Rețeaua Game of Thrones" , button :"See Project" , pic : Proj2, link : "/RețeauaGameofThrones"},
    {id:3, title: "Era Bike" , button :"See Project" , pic : Proj3, link : "/EraBkie"},
    {id:4, title: "Rețeaua Marvel Universe" , button :"See Project", pic : Proj4, link : "/MobilitateaUrbana"},
    {id:5, title: "Mobilitatea Urbană" , button :"See Project" , pic : Proj5,link : "/ReteauaMarvelUniverse"}
  ];
  return (
