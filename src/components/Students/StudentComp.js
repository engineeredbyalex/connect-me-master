...
import Student1 from "../Assets/images/StudentsPics/LuizaToma.jpg"
import Student2 from "../Assets/images/StudentsPics/LauraCiobotaru.jpg"
import Student3 from "../Assets/images/StudentsPics/RaresMot.jpg"
import Student4 from "../Assets/images/StudentsPics/ArianaNita.jpg"
...
function StudentComp() {
  ...
  return (
    <div className='bg-white h-[300vh] w-screen flex flex-col items-center justify-center sm:h-[250vh] xl:h-[280vh] 2xl:h-[100vh]'>
      <div className='h-[20vh] w-screen flex items-center justify-center text-center 2xl:h-[10vh]'>
        <h2 className='text-5xl md:text-6xl uppercase mt-10'>Students Ready to Work</h2>
      </div>
