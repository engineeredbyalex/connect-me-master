    ...
    <nav className="w-screen h-[80px] z-10 bg-[#434459] fixed drop-shadow-lg text-white ">
      <div className="px-2 flex justify-center items-center w-full h-full">
        <div className="flex items-center justify-center w-screen">
          ...
          <ul className="hidden md:flex ms:text-[15px] md:text-[20px] fixed right-0 mr-5 uppercase text-[20px] z-10">
            <Link to="/exhibition">
              <li>Exhibition</li>
            </Link>
            <Link to="/profiles">
      ...
      <motion.nav
        ...
        className={
          !toggle
            ? "hidden"
            : "absolute bg-[#434459] w-full px-8 h-[80px] flex items-center justify-center uppercase text-[20px] "
        }
      >
        <ul
          className={
            !toggle
              ? "hidden"
              : "absolute bg-[#434459] w-full px-8 h-[80px] flex items-center justify-center uppercase text-[20px] z-3 "
          }
        >
          <Link to="/exhibition">
            <li>Exhibition</li>
