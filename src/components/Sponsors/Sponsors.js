...
function Sponsors() {
  return (
    <div className='h-[60vh] w-screen bg-[#a090c1] flex items-center justify-center flex-col'>
        <h2 className='uppercase text-4xl font-semibold text-white mt-[5rem] md:text-6xl'>Powerd By</h2>
        <div className='w-screen h-[70vh] flex flex-col items-center justify-evenly lg:flex-row'>
